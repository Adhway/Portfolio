    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      />
        ...
        <div className="flex justify-center space-x-6 mb-12 animate-fade-in-delay-3">
          ...
          <a href="https://www.linkedin.com/in/adhway-sharma-592170413/" target='main'className="p-3 bg-slate-700/50 hover:bg-slate-600/50 rounded-full transition-all duration-300 hover:scale-110">
            <Linkedin size={24} />
          </a>
        </div>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-delay-4">
          <a href="https://drive.google.com/file/d/168PF8LaXyGgCGJURrVP92vwGpc7t_gsm/view?usp=sharing" target='main' className="px-8 py-3 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full font-medium hover:shadow-lg hover:shadow-cyan-500/25 transition-all duration-300 hover:scale-105">
            View My Resume
          </a>
